            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              ...
              <div className="bg-zinc-900/50 p-8 rounded-3xl border border-white/5 hover:border-amber-500/30 transition-all flex flex-col relative group">
                ...
                <button 
                  ...
                  className="w-full py-4 rounded-xl bg-white/5 hover:bg-amber-500 text-white hover:text-zinc-950 font-black tracking-widest uppercase transition-all flex items-center justify-center gap-2 group-hover:shadow-lg group-hover:shadow-amber-500/20"
                >
              ...
              <div className="bg-zinc-900 p-8 rounded-3xl border-2 border-amber-500/50 relative flex flex-col transform md:-translate-y-4 shadow-2xl shadow-amber-500/10">
                ...
                <button 
                  ...
                  className="w-full py-4 rounded-xl bg-amber-500 hover:bg-amber-400 text-zinc-950 font-black tracking-widest uppercase transition-all flex items-center justify-center gap-2 shadow-xl shadow-amber-500/20 active:scale-95"
                >
                  Assinar Agora <ChevronRight className="w-5 h-5" />
                </button>
              </div>
        ...
        <section className="px-6 py-24 bg-zinc-900 border-t border-white/5">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mt-16 flex justify-center">
              <button 
                onClick={handleStart}
                className="group relative inline-flex items-center justify-center gap-3 px-8 py-4 bg-white text-zinc-950 rounded-full font-black text-lg overflow-hidden shadow-xl hover:scale-105 transition-all hover:bg-zinc-200 active:scale-95"
              >
